...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> blogNotFoundException(DcNotFoundException exception){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(exception.getMessage());
    }

    @ExceptionHandler(value = DcAlreadyExistsException.class)
    public ResponseEntity<String> dcAlreadyExistsException(DcAlreadyExistsException exception){
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(exception.getMessage());
    }
